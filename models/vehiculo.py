...
class vehiculo(models.Model):
    ...
    cliente_id = fields.Many2one("upocar.cliente", string="Dueño del vehiculo", required=True)
    modelo_id = fields.Many2one("upocar.modelo", string="Modelo del vehiculo", required=True)
